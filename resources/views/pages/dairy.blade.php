...
<section class="relative py-24 bg-primary-600 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-primary-200 text-lg max-w-2xl mx-auto">Premium-quality dairy production through modern systems and sustainable animal care</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="animate-on-scroll">
                ...
                <p class="text-gray-600 leading-relaxed mb-6">Our dairy division focuses on healthy livestock management and premium-quality dairy production through modern dairy farming systems and sustainable animal care practices.</p>
                <h3 class="text-xl font-bold text-primary-700 mb-4">What We Produce</h3>
                <ul class="space-y-3">
                    <li class="flex items-center gap-3"><svg class="w-5 h-5 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg><span class="text-gray-600">Fresh milk</span></li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-xl p-6 shadow-sm text-center animate-on-scroll">
                ...
                <h3 class="font-bold text-primary-700 mb-2">Automated Milking Systems</h3>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm text-center animate-on-scroll" style="animation-delay: 0.1s">
                ...
                <h3 class="font-bold text-primary-700 mb-2">Veterinary Health Management</h3>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm text-center animate-on-scroll" style="animation-delay: 0.2s">
                ...
                <h3 class="font-bold text-primary-700 mb-2">Organic Feeding Systems</h3>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm text-center animate-on-scroll" style="animation-delay: 0.3s">
                ...
                <h3 class="font-bold text-primary-700 mb-2">Hygienic Milk Storage</h3>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="section-title animate-on-scroll">
            <h2 class="text-3xl md:text-4xl font-bold text-primary-600 font-serif">Benefits of Our Dairy System</h2>
            <p class="text-gray-600">A responsible dairy model built for quality, animal care, and reliable supply.</p>
        </div>
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $benefits = [
                    ...
                    'Consistent dairy supply chain',
                ];
            @endphp

            @foreach ($benefits as $benefit)
                <div class="bg-primary-50 rounded-xl p-6 text-center border border-primary-100 animate-on-scroll">
                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm">
                        <svg class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <h3 class="font-bold text-primary-700">{{ $benefit }}</h3>
                </div>
            @endforeach
        </div>
    </div>
