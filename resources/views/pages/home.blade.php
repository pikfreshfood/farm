...
@section('title', 'Crosby Farm and Investments')
@section('meta_description', 'A large-scale commercial agricultural and investment enterprise dedicated to sustainable farming, crop production, livestock rearing, dairy farming, and agricultural wealth creation across the United States.')
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="max-w-2xl">
            <div class="inline-flex items-center gap-2 bg-white/88 backdrop-blur-sm px-4 py-2 rounded-full text-primary-700 border border-primary-200 shadow-sm text-sm font-semibold mb-6 animate-fade-in-down">
                ...
                Welcome to Crosby Farm and Investments
            </div>
            
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-950 font-serif leading-tight mb-6 animate-fade-in-up">
                Feeding Tomorrow, Building Wealth for <span class="text-primary-600">Generations</span>
            </h1>
            
            <p class="text-lg text-gray-700 mb-8 leading-relaxed animate-fade-in-up max-w-xl" style="animation-delay: 0.2s">
                A large-scale commercial agricultural and investment enterprise dedicated to sustainable farming, crop production, livestock rearing, dairy farming, and agricultural wealth creation across the United States.
            </p>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="animate-on-scroll">
                <div class="inline-flex items-center gap-2 text-primary-500 font-semibold text-sm mb-4">
                    ...
                    Where Agriculture Meets Investment Opportunity.
                </div>
                
                <h2 class="text-3xl md:text-4xl font-bold text-primary-600 font-serif mb-6">Welcome to Crosby Farm and Investments</h2>
                
                <p class="text-gray-600 leading-relaxed mb-8">
                    Founded by Andre Crosby, Crosby Farm and Investments combines advanced farming technology, responsible agricultural practices, and investment-driven operations to create a profitable and sustainable agricultural ecosystem across crop cultivation, dairy production, livestock management, and agricultural investment programs.
                </p>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-primary-50 rounded-lg border border-primary-100">
                        ...
                        <span class="text-sm font-medium text-primary-700">Commercial Crop Production</span>
                    </div>
                    <div class="flex items-center gap-3 p-3 bg-primary-50 rounded-lg border border-primary-100">
                        <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center flex-shrink-0 shadow-sm">
                ...
                <div class="farm-soft-panel rounded-lg p-6 flex items-start gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">To provide high-quality agricultural products while creating profitable investment opportunities that support food security, economic development, and long-term financial growth.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="farm-card bg-white rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 animate-on-scroll">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Premium-quality dairy production through modern dairy systems and sustainable animal care.</p>
            ...
            <div class="farm-card bg-white rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 animate-on-scroll" style="animation-delay: 0.1s">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Professional management of cattle, goats, sheep, poultry, farm dogs, and other agricultural animals.</p>
            ...
            <div class="farm-card bg-white rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 animate-on-scroll" style="animation-delay: 0.2s">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Large-scale cultivation of corn, wheat, soybeans, hay, vegetables, fruits, and animal feed crops.</p>
            ...
            <div class="farm-card bg-white rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 animate-on-scroll" style="animation-delay: 0.3s">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Agricultural investment programs for long-term planning, passive income, and retirement-focused investors.</p>
...
<section class="py-16 bg-primary-50 border-y border-primary-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="section-title animate-on-scroll">
            <h2 class="text-3xl md:text-4xl font-bold text-primary-600 font-serif">Why Choose Crosby Farm and Investments?</h2>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <div class="text-center animate-on-scroll">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Large-Scale<br>Commercial Farming</h4>
            </div>
            <div class="text-center animate-on-scroll" style="animation-delay: 0.1s">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Reliable Dairy &<br>Livestock Operations</h4>
            </div>
            <div class="text-center animate-on-scroll" style="animation-delay: 0.2s">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Modern Sustainable<br>Farming Systems</h4>
            </div>
            <div class="text-center animate-on-scroll" style="animation-delay: 0.3s">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Diversified Income<br>Streams</h4>
            </div>
            <div class="text-center animate-on-scroll" style="animation-delay: 0.4s">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Investment-Friendly<br>Structure</h4>
            </div>
            <div class="text-center animate-on-scroll" style="animation-delay: 0.5s">
                ...
                <h4 class="text-sm font-semibold text-primary-700">Transparent Operational<br>Management</h4>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="farm-card relative bg-white rounded-lg p-8">
                    <div id="testimonial-slider">
                        <div class="testimonial-slide">
                            ...
                            <p class="text-gray-700 text-lg mb-6 leading-relaxed">"Crosby Farm and Investments helped me participate in agriculture while planning for long-term financial security."</p>
                ...
                <div class="farm-soft-panel rounded-lg p-8 text-center">
                    <div class="w-32 h-32 mx-auto mb-4 relative">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span class="text-xs font-bold text-primary-600 mt-1">CROSBY FARM</span>
                        </div>
                    </div>
                    <h4 class="text-lg font-bold text-primary-700 font-serif mb-2">FEEDING TOMORROW</h4>
                    <div class="inline-block bg-primary-500 text-white px-4 py-1 rounded-full text-sm font-semibold mb-2">BUILDING WEALTH FOR GENERATIONS</div>
                    <p class="text-gray-600 text-sm">WHERE AGRICULTURE MEETS INVESTMENT OPPORTUNITY</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="section-title animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-primary-600 font-serif">Built for Farm Partners and Investors</h2>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
                $features = [
                    ['title' => 'Investor Dashboard', 'text' => 'Personalized access to reports, plan details, and farm performance updates.'],
                    ['title' => 'Online Investment Registration', 'text' => 'A guided path for starting a farm investment inquiry online.'],
                    ['title' => 'Live Farm Updates', 'text' => 'Current updates from dairy, livestock, crop, and sustainability operations.'],
                    ['title' => 'Milk Production Statistics', 'text' => 'Transparent dairy production figures for active farm partners.'],
                    ['title' => 'Newsletter Subscription', 'text' => 'Regular farm news, investment education, and seasonal updates.'],
                    ['title' => 'Online Consultation Booking', 'text' => 'Simple scheduling for farm tours and investor consultations.'],
                ];
            @endphp

            @foreach ($features as $feature)
                <div class="bg-white rounded-lg p-6 shadow-sm border border-primary-100 animate-on-scroll">
                    <h3 class="text-lg font-bold text-primary-700 mb-2">{{ $feature['title'] }}</h3>
...
<section class="py-20 bg-gradient-to-r from-primary-900 via-primary-700 to-primary-600 relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-primary-200 text-lg mb-8 max-w-2xl mx-auto">Join investors who trust Crosby Farm and Investments for diversified agricultural operations, transparent management, and long-term growth opportunities.</p>
...
<script>
    ...
    const testimonials = [
        {
            text: "Crosby Farm and Investments helped me participate in agriculture while planning for long-term financial security.",
        ...
        {
            text: "I love how the company combines modern farming technology with sustainable agriculture. Truly inspiring.",
