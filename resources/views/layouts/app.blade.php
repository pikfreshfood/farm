        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-2">
                <div class="hidden sm:flex items-center gap-4 sm:gap-6">
                    <a href="tel:+16075550198" class="flex items-center gap-1.5 hover:text-gold-300 transition-colors">
                        <span>(607) 555-0198</span>
                    </a>
                    <a href="mailto:info@heritagevalleyfarms.com" class="flex items-center gap-1.5 hover:text-gold-300 transition-colors">
                        <span>info@heritagevalleyfarms.com</span>
                    </a>
                </div>
